      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            action = req.params[0];
            _context.t0 = action;
            _context.next = _context.t0 === 'get-full-data' ? 4 : _context.t0 === 'get-data' ? 7 : 10;
            break;
...
/*!***********************************************************!*\
  !*** ./expressMiddlewares/thermostatServices/services.js ***!
  \***********************************************************/
/*! exports provided: getFullReadings, getReadings */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getReadings = /*#__PURE__*/function () {
  var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2(req, res, thermostatData) {
    var thermostatString, thermostatReadings, response, result, i;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            thermostatString = '[' + req.query.data.split('][').join('],[') + ']';
            thermostatReadings = JSON.parse(thermostatString);
            _context2.next = 6;
          ...
          case 6:
            ...
            for (i = 0; i < response.length; i++) {
              ...
              thermostatData[i].curentTemp = thermostatReadings[i][2]; // get the desired temperature

              result += response[i].id + ',' + response[i].curentTemp + ',' + response[i].requiredTemp + ',';
            }

            result += '0]'; //result = '[0,' + new Date().getSeconds() + ',28.00],[1,30.21,28.25][' + new Date().getSeconds() + ']';
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_7___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this), "fetchData", function () {
      fetch("".concat("http://localhost", ":").concat("8081", "/thermostat-services/get-full-data")).then(function (response) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (typeof _this.changeRange[i] != 'undefined') _this.changeRange[i](curentTemp);
        }
