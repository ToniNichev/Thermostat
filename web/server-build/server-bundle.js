...
/* harmony import */ var _RangeSlider__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../RangeSlider */ "./src/components/RangeSlider/index.js");
/* harmony import */ var _TemperatureBar__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../TemperatureBar */ "./src/components/TemperatureBar/index.js");
...
var Home = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Home, [{
    ...
    value: function onChangeCallback(e) {
    ...
    value: function fetchData() {
      ...
      fetch('http://localhost:8081/services/thermostats-data').then(function (response) {
        ...
        console.log("!!@!@!@");
        console.log(_this2.state.thermostats[0].curentTemp);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, "FLAGS"), featureFlags.map(function (flag, id) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
          key: flag.flagName,
          ...
          flagName: flag.flagName,
          status: _this3.state.flagEditable
          ...
          val: flag.value
        })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_RangeSlider__WEBPACK_IMPORTED_MODULE_15__["default"], {
          onChangeCallback: _this3.onChangeCallback
        }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_TemperatureBar__WEBPACK_IMPORTED_MODULE_16__["default"], {
          temp: typeof _this3.state.thermostats[id] == 'undefined' ? 0 : _this3.state.thermostats[id].curentTemp
        }), "ID: ", id);
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
...
var RangeSlider = function RangeSlider(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "Set Temperature: "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "range",
    min: "1",
    max: "100",
    defaultValue: "50",
...
// extracted by mini-css-extract-plugin
module.exports = {"label":"RangeSlider-label--2RwQB"};
...
var ThermostatData = function ThermostatData(id, curentTemp, requiredTemp) {
  return {
    id: id,
...
app.get('/services/thermostats-data', /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            response = JSON.stringify(thermostatsData);
...
app.get('/services/data', /*#__PURE__*/function () {
  var _ref9 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee8(req, res) {
    var response, data, thermostats, offset, _i, id, curentTemp, requiredTemp;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            for (_i = 0; _i < thermostats; _i++) {
              offset = _i * 3;
              id = data[offset + 1];
              curentTemp = data[offset + 2];
              requiredTemp = data[offset + 3];
              thermostatsData[_i].id = id;
              thermostatsData[_i].curentTemp = curentTemp;
              thermostatsData[_i].requiredTemp = requiredTemp;
