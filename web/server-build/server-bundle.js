...
var mouseMoveAction = function mouseMoveAction(e) {
  ...
  var center_x = document.querySelector('.circle').offsetWidth / 2 + document.querySelector('.circle').offsetLeft;
  var center_y = document.querySelector('.circle').offsetHeight / 2 + document.querySelector('.circle').offsetTop;
  var eventObj;
  ...
  document.querySelector('.dot').style.transform = "rotate(".concat(angle, "deg)");
  val = angle;
...
var RangeSlider = function RangeSlider(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    document.querySelector('.dot').addEventListener('touchend', function (e) {
      beginDrag = false;
    });
    document.querySelector('.dot').addEventListener('mousedown', function (e) {
      beginDrag = true;
    });
    document.querySelector('.dot').addEventListener('mouseup', function (e) {
      beginDrag = false;
    });
